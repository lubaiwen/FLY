CREATE DATABASE IF NOT EXISTS drone_nest_system CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE drone_nest_system;
...
('NT002', '大学城充电站B', '117.1689,31.8421', 117.1689, 31.8421, 1800, 6, 0, 2, NOW()),
('NT003', '经开区充电站C', '117.2701,31.8198', 117.2701, 31.8198, 2000, 5, 0, 2, NOW()),
...
-- 默认用户数据
INSERT INTO users (username, password, name, role, enterprise, phone, email, status) VALUES
('admin', '$2a$10$JNvlO7QP4FJ4Tu05n3n3A.agiRnXUhwv6CK/HcyC5AgPaklzqYWZ2', '管理员', 'admin', NULL, '13800138000', 'admin@example.com', 1),
('operator', '$2a$10$ju9uNruRxT1LsAdcmqc1KufxRhmzUDV6YoXxrb5fLJpytpNeJ1T0K', '运维人员', 'operator', NULL, '13900139000', 'operator@example.com', 1),
('enterprise', '$2a$10$yVuImjMB0KOGWM.t9/VuU.MTavgQ0ipnh2G1wZOWGsVJHQ./PQeZq', '企业用户', 'enterprise', '顺丰速运', '13700137000', 'enterprise@example.com', 1);
